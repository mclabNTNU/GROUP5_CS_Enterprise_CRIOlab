...
<outport> id = "-1" name = "eta_m" width = "3" datatype = "25"</outport>
<outport> id = "-1" name = "eta_after_droput" width = "3" datatype = "25"</outport>
...
<outport> id = "-1" name = "tau to CSE mocell (only use for HIL testing)/integrator reset model" width = "1" datatype = "25"</outport>
