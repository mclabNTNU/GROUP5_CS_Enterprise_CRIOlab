	<portlist>
<inport> id="-1"  name = "Surge Observer/K_psi_in" width = "1" datatype = "0"</inport>
...
<outport> id = "-1" name = "tau to CSE mocell (only use for HIL testing)/X_d" width = "1" datatype = "20"</outport>
<outport> id = "-1" name = "tau to CSE mocell (only use for HIL testing)/N_d" width = "1" datatype = "20"</outport>
<outport> id = "-1" name = "tau to CSE mocell (only use for HIL testing)/Y_d" width = "1" datatype = "20"</outport>
...
<outport> id = "-1" name = "Surge Observer/K_psi_out" width = "1" datatype = "0"</outport>
<outport> id = "-1" name = "Surge Observer/x_lowpass" width = "1" datatype = "0"</outport>
</portlist>
