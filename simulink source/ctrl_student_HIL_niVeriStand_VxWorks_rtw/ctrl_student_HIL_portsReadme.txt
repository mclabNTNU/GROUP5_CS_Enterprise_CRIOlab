...
<outport> id = "-1" name = "tau to CSE mocell (only use for HIL testing)/X_d" width = "1" datatype = "30"</outport>
<outport> id = "-1" name = "tau to CSE mocell (only use for HIL testing)/N_d" width = "1" datatype = "30"</outport>
<outport> id = "-1" name = "tau to CSE mocell (only use for HIL testing)/Y_d" width = "1" datatype = "30"</outport>
...
<outport> id = "-1" name = "Observer/nu_hat" width = "3" datatype = "28"</outport>
<outport> id = "-1" name = "Observer/eta_hat" width = "3" datatype = "28"</outport>
<outport> id = "-1" name = "Observer/b_hat" width = "3" datatype = "28"</outport>
<outport> id = "-1" name = "Observer/eta_tilde" width = "3" datatype = "38"</outport>
<outport> id = "-1" name = "Observer/nu_tilde" width = "3" datatype = "38"</outport>
</portlist>
