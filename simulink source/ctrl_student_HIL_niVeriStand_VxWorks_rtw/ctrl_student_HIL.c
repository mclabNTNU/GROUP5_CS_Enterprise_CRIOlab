...
void ctrl_student_HIL_output(void)
{
  ...
  ctrl_student_HIL_B.fault = !((-1.0 <= ctrl_student_HIL_B.u_BT) &&
    ...
    1.0));
  if (rtmIsMajorTimeStep(ctrl_student_HIL_M)) {
    /* MATLAB Function 'tau to real ship (only use in MCLab)/Full thrust allocation2': '<S49>:1' */
    /*  Forces and moments vector */
    /* '<S49>:1:4' */
    /*  Extended thrust configuration matrix */
    /*  Extended thrust coefficient matrix */
...
RT_MODEL_ctrl_student_HIL_T *ctrl_student_HIL(void)
{
  ...
  ctrl_student_HIL_M->Sizes.numBlockPrms = (528);/* Sum of parameter "widths" */
...
static NI_Parameter NI_ParamList[] DataSection(".NIVS.paramlist") =
{
  ...
  { 28, "ctrl_student_hil/from ship/Constant/Value", offsetof
    (P_ctrl_student_HIL_T, Constant_Value_k), 55, 1, 2, 56, 0 },

  { 29, "ctrl_student_hil/from ship/Constant1/Value", offsetof
    (P_ctrl_student_HIL_T, Constant1_Value_c), 55, 1, 2, 58, 0 },

  { 30, "ctrl_student_hil/from ship/Switch/Threshold", offsetof
    (P_ctrl_student_HIL_T, Switch_Threshold_m), 55, 1, 2, 60, 0 },
};
...
static char* NI_CompiledModelName DataSection(".NIVS.compiledmodelname") =
  "ctrl_student_hil";
static char* NI_CompiledModelVersion = "1.238";
static char* NI_CompiledModelDateTime = "Fri Apr 28 05:58:56 2017";
