...
typedef struct {
  ...
  real_T u[3];                         /* '<S3>/MATLAB Function' */
  real_T integral;                     /* '<S2>/inside of integral' */
...
typedef struct {
  ...
  real_T u_derrivatice_DWORK1;         /* '<Root>/u_derrivatice' */
  ...
  uint8_T u_derrivatice_DWORK2[17];    /* '<Root>/u_derrivatice' */
...
struct P_ctrl_student_HIL_T_ {
  ...
  real_T u_hat_P6;                     /* Expression: btype
                                        * Referenced by: '<Root>/u_hat'
                                        */
  real_T u_derrivatice_P1;             /* Expression: width
                                        * Referenced by: '<Root>/u_derrivatice'
                                        */
  real_T u_derrivatice_P2;             /* Expression: dtype
                                        * Referenced by: '<Root>/u_derrivatice'
                                        */
  real_T u_derrivatice_P3;             /* Expression: portnum
                                        * Referenced by: '<Root>/u_derrivatice'
                                        */
  real_T u_derrivatice_P4;             /* Expression: stime
                                        * Referenced by: '<Root>/u_derrivatice'
                                        */
  real_T u_derrivatice_P5;             /* Expression: stype
                                        * Referenced by: '<Root>/u_derrivatice'
                                        */
  real_T u_derrivatice_P6;             /* Expression: btype
                                        * Referenced by: '<Root>/u_derrivatice'
                                        */
 ...
 * '<S2>'   : 'ctrl_student_HIL/Surge Observer'
 ...
 * '<S14>'  : 'ctrl_student_HIL/Surge Observer/inside of integral'
 * '<S15>'  : 'ctrl_student_HIL/Thrust allocation/MATLAB Function'
 * '<S16>'  : 'ctrl_student_HIL/Thrust allocation/MATLAB Function1'
 */
