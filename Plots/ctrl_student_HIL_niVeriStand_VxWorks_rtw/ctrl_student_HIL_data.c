...
P_ctrl_student_HIL_T ctrl_student_HIL_P = {
  ...
  0.0,                                 /* Expression: 0
                                        ...
                                        */
  58338.0,                             /* Expression: ceil(abs(3*round(abs(now*1e6 - fix(now*1e6))*1e5)))
                                        * Referenced by: '<S10>/North Noise'
                                        */
  0.0,                                 /* Expression: 0
                                        * Referenced by: '<S10>/East Noise'
                                        */
  79895.0,                             /* Expression: ceil(abs(5*round(abs(now*1e6 - fix(now*1e6))*1e5)))
                                        * Referenced by: '<S10>/East Noise'
                                        */
  0.0,                                 /* Expression: 0
                                        * Referenced by: '<S10>/Heading Noise'
                                        */
  188386.0,                            /* Expression: ceil(abs(11*round(abs(now*1e6 - fix(now*1e6))*1e5)))
                                        * Referenced by: '<S10>/Heading Noise'
                                        */
  0.0,                                 /* Expression: 0
  ...
  1.0,                                 /* Computed Parameter: RandomNumber_StdDev
                                        * Referenced by: '<S11>/Random Number'
                                        */
  498840.0,                            /* Expression: ceil(abs(5*round(abs(now*1e6 - fix(now*1e6))*1e5)))
                                        * Referenced by: '<S11>/Random Number'
                                        */
  0.0,                                 /* Expression: 0
  ...
  1.0,                                 /* Computed Parameter: RandomNumber_StdDev_b
                                        * Referenced by: '<S12>/Random Number'
                                        */
  27770.0,                             /* Expression: ceil(abs(5*round(abs(now*1e6 - fix(now*1e6))*1e5)))
                                        * Referenced by: '<S12>/Random Number'
                                        */
  0.0,                                 /* Expression: 0
  ...
  1.0,                                 /* Computed Parameter: RandomNumber_StdDev_h
                                        * Referenced by: '<S13>/Random Number'
                                        */
  62500.0,                             /* Expression: ceil(abs(5*round(abs(now*1e6 - fix(now*1e6))*1e5)))
                                        * Referenced by: '<S13>/Random Number'
                                        */
  0.0,                                 /* Expression: 0
