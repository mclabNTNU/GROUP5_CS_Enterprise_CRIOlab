...
typedef struct {
  ...
  real_T stop_at_pos;                  /* '<S15>/stop_at_pos' */
  real_T mu;                           /* '<S15>/mu' */
  ...
  real_T u_in;                         /* '<S9>/u_in' */
  real_T v_in;                         /* '<S9>/v_in' */
  real_T u_BT;                         /* '<S13>/Full thrust allocation1' */
  real_T u_VSP;                        /* '<S13>/Full thrust allocation1' */
  real_T alpha_VSP;                    /* '<S13>/Full thrust allocation1' */
  real_T omega_VSP;                    /* '<S13>/Full thrust allocation1' */
...
typedef struct {
  ...
  real_T stop_at_pos_DWORK1;           /* '<S15>/stop_at_pos' */
  ...
  real_T alpha_VSP1_DWORK1_g;          /* '<S54>/alpha_VSP1' */
  real_T alpha_VSP2_DWORK1_i;          /* '<S54>/alpha_VSP2' */
  real_T omega_VSP1_DWORK1_c;          /* '<S54>/omega_VSP1' */
  real_T omega_VSP2_DWORK1_k;          /* '<S54>/omega_VSP2' */
  real_T u_BT_DWORK1_c;                /* '<S54>/u_BT' */
  real_T u_VSP1_DWORK1_i;              /* '<S54>/u_VSP1' */
  real_T u_VSP2_DWORK1_o;              /* '<S54>/u_VSP2' */
  ...
  real_T backwards;                    /* '<S15>/update law' */
  ...
  uint8_T stop_at_pos_DWORK2[17];      /* '<S15>/stop_at_pos' */
  ...
  uint8_T controlinputuexceedsbounds_DW_h[17];/* '<S52>/control input u exceeds bounds' */
  uint8_T alpha_VSP1_DWORK2_b[17];     /* '<S54>/alpha_VSP1' */
  uint8_T alpha_VSP2_DWORK2_l[17];     /* '<S54>/alpha_VSP2' */
  uint8_T omega_VSP1_DWORK2_p[17];     /* '<S54>/omega_VSP1' */
  uint8_T omega_VSP2_DWORK2_h[17];     /* '<S54>/omega_VSP2' */
  uint8_T u_BT_DWORK2_e[17];           /* '<S54>/u_BT' */
  uint8_T u_VSP1_DWORK2_k[17];         /* '<S54>/u_VSP1' */
  uint8_T u_VSP2_DWORK2_l[17];         /* '<S54>/u_VSP2' */
 ...
 * '<S48>'  : 'ctrl_student_HIL/tau to real ship (only use in MCLab)/Full thrust allocation1'
 * '<S49>'  : 'ctrl_student_HIL/tau to real ship (only use in MCLab)/Full thrust allocation2'
 * '<S50>'  : 'ctrl_student_HIL/tau to real ship (only use in MCLab)/Full thrust allocation3'
